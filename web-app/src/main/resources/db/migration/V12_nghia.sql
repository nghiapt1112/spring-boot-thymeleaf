...
INSERT INTO `package`.`m_product`(`tenant_id`, `product_id`, `code`, `name`, `unit`, `price`, `category1`, `category2`, `category3`, `temperature`)
VALUES
(2, 'product_id_1', '0001', 'name1', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_2', '0002', 'name2', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_3', '0003', 'name3', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_4', '0004', 'name4', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_5', '0005', 'name5', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_6', '0006', 'name6', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_7', '0007', 'name7', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_8', '0008', 'name8', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_9', '0009', 'name9', 'unit', 10.0, 'cat1', 'cat2', 'cat3', 'temp'),
(2, 'product_id_10','0010', 'name10', 'unit',10.0, 'cat1', 'cat2', 'cat3', 'temp')
;

INSERT INTO `package`.`t_order_detail`(`tenant_id`, `order_detail_id`, `order_id`, `product_id`, `amount`)
VALUES
...
;
INSERT INTO `package`.`m_package`(`tenant_id`, `pakage_id`, `name`, `unit`, `empty_weight`, `full_load_weight`, `empty_capacity`, `full_load_capacity`)
VALUES
