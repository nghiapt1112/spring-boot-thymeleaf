...
CREATE TABLE `m_post_course`  (
  ...
  `post` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `course` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `create_date` timestamp(0) NULL COMMENT '作成日時',
...
CREATE TABLE `m_product`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL COMMENT '商品名',
  `unit` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '単位',
  `price` decimal(10, 2) NULL,
  `category1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL COMMENT '大分類',
  `category2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '大分類',
  `category3` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '大分類',
  `temperature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '温度',
  `create_date` timestamp(0) NULL COMMENT '作成日時',
  `create_user` varchar(36)  NULL COMMENT '作成ユーザーID',
  `update_date` timestamp(0) NULL COMMENT '更新日時',
  `update_user` varchar(36)  NULL COMMENT '更新ユーザーID',
...
CREATE TABLE `m_user`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '名前',
...
CREATE TABLE `t_order`  (
  ...
  `post` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '便',
  `create_date` timestamp(0) NULL COMMENT '作成日時',
  `create_user` varchar(36)  NULL COMMENT '作成ユーザーID',
  `update_date` timestamp(0) NULL COMMENT '更新日時',
  `update_user` varchar(36)  NULL COMMENT '更新ユーザーID',
...
CREATE TABLE `t_order_detail`  (
  `tenant_id` int(11) NOT NULL,
  `order_detail_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '発注詳細ID',
  `order_id` varchar(36) COMMENT '発注ID',
